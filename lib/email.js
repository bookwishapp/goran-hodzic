...
<body>
    ...
    <div class="footer">
        <p>
            Goran Hodzic Art · <a href="https://goranhodzic.com">goranhodzic.com</a>
        </p>
        <p>
        ...
        <p>
            ...
            <a href="https://goranhodzic.com/support">Support the Art</a>
        </p>
    </div>
</body>
</html>
...
async function sendEmail({ to, subject, content, isNewsletter = false }) {
  ...
  const fromEmail = process.env.SES_FROM_EMAIL || 'hello@goranhodzic.com';
