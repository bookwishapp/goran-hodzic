  ...
  return (
    <>
      <header className="site-header">
        <h1 className="site-title">Goran Hodzic Art</h1>
        <p className="site-author">Goran Hodzic</p>
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <h1 className={styles.title}>Support Goran Hodzic Art</h1>
          <p className={styles.description}>
            Creating art takes dedication. Your support helps make it possible.
          </p>
        ...
        <div className={styles.footer}>
          ...
          <p>
            <a href="/">← Back to Goran Hodzic Art</a>
          </p>
        </div>
      </div>
    </div>
